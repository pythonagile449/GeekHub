        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activate_key_expires',
                 models.DateTimeField(default=datetime.datetime(2021, 7, 8, 1, 27, 26, 26506, tzinfo=utc),
                ...
                ('gender', models.CharField(choices=[('O', 'другой'), ('M', 'мужской'), ('W', 'женский')], default='O',
                                            max_length=1, verbose_name='Пол')),
                ('article_redactor',
                 models.CharField(choices=[('MD', 'markdown'), ('CK', 'сkeditor')], default='CK', max_length=2,
